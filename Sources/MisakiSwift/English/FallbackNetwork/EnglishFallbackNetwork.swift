...
final class EnglishFallbackNetwork {
  ...
  private static func loadConfig(british: Bool) -> BARTConfig? {
    ...
    guard let url = Bundle.module.url(forResource: fileName, withExtension: "json", subdirectory: "PackageData"),
  ...
  private static func loadWeights(british: Bool) -> [String: MLXArray]? {
    ...
    guard let url = Bundle.module.url(forResource: fileName, withExtension: "safetensors", subdirectory: "PackageData"),
